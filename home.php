  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\redcross.png" alt="image\image_not_found.jpg" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to BloodBank Information System</h1>
<br>
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >Why should i donate blood?</h4>
